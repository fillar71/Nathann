...
export default function Sidebar() {
  ...
  return (
    <div className="w-[260px] flex-shrink-0 border-r border-border flex flex-col bg-card">
      ...
      <div className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold mb-2 mt-6 px-4">Workspace</div>
      ...
      <div className="p-4 mt-auto border-t border-border bg-card">
        <div className="flex items-center gap-3 p-2 bg-background rounded-lg border border-border/50">
          <div className="w-8 h-8 rounded-full bg-muted flex items-center justify-center text-xs font-semibold text-foreground">JD</div>
